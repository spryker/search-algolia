...
interface SearchAlgoliaClientInterface
{
    /**
     * Specification:
    ...
    /**
     * Specification:
     * - Stores a single document in Algolia.
     *
     * @api
     *
     * @param \Generated\Shared\Transfer\SearchDocumentTransfer $searchDocumentTransfer
    ...
    /**
     * Specification:
     * - Stores multiple documents in Algolia.
     *
     * @api
     *
    ...
    /**
     * Specification:
     * - Sends request to Algolia for checking connection.
     *
     * @api
     *
